...
public class DraftDataAnalyzer {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Would you like to provide the name of a file with data? (Y/N)");
		List<Double> listOfNumbers = null;
		listOfNumbers = evaluateUserInput(br, listOfNumbers);
	...
	public static List<Double> evaluateUserInput(BufferedReader br, List<Double> listOfNumbers) throws IOException {
		int numberOfTries = 3;
	...
	public static List<Double> readAListOfNumbersFromConsole(BufferedReader br) throws IOException {
		...
		String input = br.readLine().trim(); // gets rid of leading or trailing
												// spaces
		List<Double> listOfNumbers = new ArrayList<Double>();
	...
	public static double findMaxValue(List<Double> list) {
		double max = Double.NEGATIVE_INFINITY; // Need small negative number but
												// Double.MIN_VALUE is the
